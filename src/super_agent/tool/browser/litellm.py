...
class LiteLLMModel(ApiModel):
    ...
    def _prepare_completion_kwargs(
        ...
        **kwargs,
        ...
        # Have to include this to use gpt-5 (gpt-5 doesn't support stop)
        model_id = completion_kwargs.get("model", "") or self.model_id
        UNSUPPORTED_STOP_PREFIXES = ("gpt-5")
        if any(model_id.startswith(pfx) for pfx in UNSUPPORTED_STOP_PREFIXES):
